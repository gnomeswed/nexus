  ...
  async render(id) {
    ...
    return `
      ...
      <div class="page-body">
          ...
          <div id="perms-container" style="display:none;margin-top:16px">
            <div class="grid-3">
              <div style="padding-right:16px;border-right:1px solid var(--border)">
                <div style="font-size:11px;font-weight:700;color:var(--text-secondary);text-transform:uppercase;letter-spacing:1px;margin-bottom:12px">🏗️ Gerenciamento</div>
              ...
              <div style="padding:0 16px;border-right:1px solid var(--border)">
                <div style="font-size:11px;font-weight:700;color:var(--text-secondary);text-transform:uppercase;letter-spacing:1px;margin-bottom:12px">📁 Arquivos</div>
              ...
              <div style="padding-left:16px">
                <div style="font-size:11px;font-weight:700;color:var(--text-secondary);text-transform:uppercase;letter-spacing:1px;margin-bottom:12px">⚡ Outros</div>
        ...
        <!-- Bottom Grid: Prompt and Error Logs -->
        <div class="grid-2">
          <div class="card">
            <h3 style="margin-bottom:16px;font-size:15px">💬 System Prompt</h3>
            <div class="form-group" style="margin:0">
              <textarea class="form-textarea" id="ed-prompt" rows="12" style="font-family:monospace;font-size:13px">${agent.system_prompt || ''}</textarea>
            </div>
          </div>

          <div class="card" style="${agent.errors && agent.errors.length > 0 ? 'border-top:4px solid var(--accent-danger)' : ''}">
            ...
            <div style="display:flex;flex-direction:column;gap:12px;max-height:300px;overflow-y:auto;padding-right:8px">
              ${agent.errors && agent.errors.length > 0 ? agent.errors.map(err => `
                <div style="background:rgba(255,107,107,0.05);padding:12px;border-radius:6px;border:1px solid rgba(255,107,107,0.1)">
